...
void fibonacci_search(Node *head, int key)
{
    ...
    while (fibM > 1)
    {
        ...
        {
            while (i < n && nodes[i]->price == key)
            {
                cout << "Produk ditemukan: " << nodes[i]->product_name << ", Merk: " << nodes[i]->merk
                        << ", Harga: " << nodes[i]->price << ", Stok: " << nodes[i]->stock << endl;
                i++;
            }
            return;
        }
    ...
    {
        cout << "Produk ditemukan: " << nodes[offset + 1]->product_name << ", Merk: " << nodes[offset + 1]->merk
                << ", Harga: " << nodes[offset + 1]->price << ", Stok: " << nodes[offset + 1]->stock << endl;
    }
    else
    {
        cout << "Produk tidak ditemukan." << endl;
